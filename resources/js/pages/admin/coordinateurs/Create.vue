<template>
    <div class="coordinateur-form">
        <div class="page-header">
            <RouterLink to="/admin/coordinateurs" class="back-link"
                >← Retour</RouterLink
            >
            <h1 class="page-title">Nouveau coordinateur</h1>
        </div>
        ...
        <form class="form-card" @submit.prevent="submit">
            <div class="form-grid">
                ...
                <div class="field">
                    ...
                    <input
                        ...
                        v-model="form.email"
                        required
                        placeholder="sandra@entreprise.com"
                    />
                </div>
            ...
            <div class="form-actions">
                <RouterLink to="/admin/coordinateurs" class="btn-secondary"
                    >Annuler</RouterLink
                >
                <button type="submit" class="btn-primary" :disabled="loading">
                    {{ loading ? "Création…" : "Créer le coordinateur" }}
                </button>
            </div>
        </form>
    </div>
...
async function submit() {
    ...
    errorMsg.value = "";
    try {
        const res = await fetch("/api/admin/coordinateurs", {
            method: "POST",
            headers: headers(),
