                ...
                <div v-else class="collectes-list">
                    ...
                    >
                        <div class="collecte-header">
                            <span :class="['badge', collecte.statut]">{{
                                labelStatut(collecte.statut)
                            }}</span>
                            <span class="collecte-date">{{
                                formatDate(collecte.date_debut)
                            }}</span>
                        </div>
                        <p class="collecte-lieu">
                            {{ collecte.lieu ?? "Lieu à définir" }}
                        </p>
                        <p class="collecte-horaires">
                            {{ collecte.horaires ?? "" }}
                        </p>
                        <div class="collecte-stats">
                            <span
                                ...
                                inscrits</span
                            >
                            <span v-if="collecte.objectif_dons"
                                >Objectif : {{ collecte.objectif_dons }}</span
                            >
                        </div>
                    </div>
                </div>
